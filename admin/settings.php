<?php
// Bigloltrash 17/02/2018 : specific css load option
global $nm_forms_c;
?>
...
<div class="wrap">
	...
	<div class="nm_settings_container">
		...
		<table class="form-table">
			<tr>
				<th>ReCaptcha support:</th>
				<td>
					<?php echo 'file_get_contents : ', ini_get('allow_url_fopen') ? '<span style="color:green;" class="dashicons dashicons-yes"></span> Enabled' : '<span class="dashicons dashicons-warning" style="color:red;"></span> Disabled'; ?><br/>
					<?php echo 'Curl: ', function_exists('curl_version') ? '<span class="dashicons dashicons-yes" style="color:green;"></span> Enabled' : '<span class="dashicons dashicons-warning" style="color:red;"></span> Disabled'; ?><br/><br/>

					<p class="description">At least one of the above should be enabled, otherwise reCaptcha won't work. In this case try contact your hosting provider, and ask to enable curl or fopen.</a></p>
			...
			<tr>
				...
				<td>
					...
					?>
					<input type="text" class="regular-text" name="nm_f_s[own_css]" value="<?=$nm_form_s['own_css'];?>">
					<p class="description">This will load your own plugin CSS. You must have uploaded it in <? echo $upload_dir; ?>/.</p>
				</td>
			</tr>
			<tr>
				<th>
